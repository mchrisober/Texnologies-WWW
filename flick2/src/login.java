...
private static final String LOGIN_QUERY = "select * From papi where username=? and password=?";
private static final String HOME_PAGE = "start";
private static final String LOGIN_PAGE = "login.jsp";
private Connection getConnection() throws Exception {
   Connection conn = null;
   try {
     String url = "jdbc:mysql://localhost/marios";       
     Class.forName("com.mysql.jdbc.Driver");
     conn = DriverManager.getConnection(url,"root","254212");
